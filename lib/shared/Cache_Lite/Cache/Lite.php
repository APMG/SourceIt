...
class Cache_Lite {
     ...
     * @param boolean $doNotTestCacheValidity (optional) if set to true, the cache validity won't be tested
     ...
     * @param string  $id                cache id
     * @param string  $group             (optional) name of the cache group
     * @param boolean $checkbeforeunlink (optional) check if file exists before removing it
     ...
     * @access public
     * @param string  $group (optional) name of the cache group
     * @param string  $mode  (optional) flush cache mode : 'old', 'ingroup', 'notingroup',
     * @return boolean true if no problem
     */
